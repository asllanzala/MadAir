...
public class RemoveAuthDeviceTask extends BaseRequestTask {
    ...
    public RemoveAuthDeviceTask(int deviceId, IRequestParams requestParams, IActivityReceive iReceiveResponse) {
    ...
    protected ResponseResult doInBackground(Object... params) {
        ...
        ResponseResult reLoginResult = reloginSuccessOrNot(RequestID.REMOVE_DEVICE_AUTH);
        if (reLoginResult.isResult()) {
            ResponseResult result = HttpProxy.getInstance().getWebService()
                    .removeDeviceAuth(mDeviceId, mSessionId, mRequestParams, mIReceiveResponse);
