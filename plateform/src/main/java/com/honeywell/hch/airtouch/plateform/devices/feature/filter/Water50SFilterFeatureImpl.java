 ...
 */
public class Water50SFilterFeatureImpl implements IFilterFeature {
    ...
    public String[] getFilterNames() {
        return new String[]{mContext.getString(R.string.composite_filter),
                mContext.getString(R.string.aqua_50_membrane_filter), mContext.getString(R.string.carbon_filter)};
    }
...
//                "model=YCX-FX150-101&product=YCZ-CT8-HRO-001&country=China&version=3",
//                AppConfig.shareInstance().getBasePurchaseUrl() + "model=YCX-MXRO8-101&product=YCZ-CT8-HRO-001&country=China&version=3",
//                AppConfig.shareInstance().getBasePurchaseUrl() + "model=YCX-XXSAC80-101&product=YCZ-CT8-HRO-001&country=China&version=3"};

        return new String[]{AppConfig.shareInstance().getDevicePurchaseUrl("3","YCX-FX150-101","YCZ-CT8-HRO-001"),
                AppConfig.shareInstance().getDevicePurchaseUrl("3","YCX-MXRO8-101","YCZ-CT8-HRO-001"),
