...
//                "model=YCX-FX150-101&product=YCZ-CT15-HRO-001&country=China&version=3",
//                AppConfig.shareInstance().getBasePurchaseUrl() + "model=YCX-MXRO15-101&product=YCZ-CT15-HRO-001&country=China&version=3",
//                AppConfig.shareInstance().getBasePurchaseUrl() + "model=YCX-XXSAC80-101&product=YCZ-CT15-HRO-001&country=China&version=3"};

        return new String[]{AppConfig.shareInstance().getDevicePurchaseUrl("3","YCX-FX150-101","YCZ-CT15-HRO-001"),
                AppConfig.shareInstance().getDevicePurchaseUrl("3","YCX-MXRO15-101","YCZ-CT15-HRO-001"),
                AppConfig.shareInstance().getDevicePurchaseUrl("3","YCX-XXSAC80-101","YCZ-CT15-HRO-001")};
    }
