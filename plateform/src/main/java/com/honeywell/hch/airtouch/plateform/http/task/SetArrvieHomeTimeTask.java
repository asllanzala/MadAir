 ...
 */
public class SetArrvieHomeTimeTask extends BaseRequestTask {
    ...
    public SetArrvieHomeTimeTask(int locationId, IRequestParams requestParams, IActivityReceive iReceiveResponse) {
    ...
    protected ResponseResult doInBackground(Object... params) {
        ...
        if (reLoginResult.isResult()) {
            ResponseResult addResult = HttpProxy.getInstance().getWebService()
                    .setArriveHomeTime(mLocationId, mSessionId,
...
//                //get location
//                HttpProxy.getInstance().getWebService().getLocation(accountApp.getUserID(), accountApp.getSessionId(), null, null);
