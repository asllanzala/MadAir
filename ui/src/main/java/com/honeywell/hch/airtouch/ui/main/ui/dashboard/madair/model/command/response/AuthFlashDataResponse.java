 ...
 */
public class AuthFlashDataResponse extends ResponseCommand {
    ...
    public AuthFlashDataResponse(byte[] data) {
        super(data);
    ...
    // one package contains 1 set of data, the set contains 8 bytes
    private void parseFlashData(byte[] data) {
        byte[] flash = new byte[8];

        flash = new byte[8];
        System.arraycopy(data, 4, flash, 0, 8);

        parseEachFlashData(flash);
