...
import com.honeywell.hch.airtouch.ui.Zxing.camera.open.OpenCameraInterface;
...
//      rect.bottom = rect.bottom * cameraResolution.y / screenResolution.y;
    ...
    public void openOrShutCameraLigh(ImageView mCameraIv) {
        if (camera != null) {
            ...
            if (Parameters.FLASH_MODE_OFF.equals(parameters.getFlashMode())) {
                try {
                    ...
                    mCameraIv.setImageResource(R.drawable.camera_light_shut);
                } catch (Exception ex) {
                    ex.printStackTrace();
                }
            }
            //关闭闪光灯
                ...
                try {
                    ...
                    camera.setParameters(parameters);
                    mCameraIv.setImageResource(R.drawable.camera_light_open);
                } catch (Exception ex) {
                    ex.printStackTrace();
                }
            }
