...
//		mTouchSlop = _ViewConfiguration.getScaledTouchSlop();
        ...
        hyperspaceJumpAnimation = AnimationUtils.loadAnimation(
                pContext, R.anim.loading_animation);
...
//        setOnScrollListener(this);
    ...
    private void addHeadView() {
        ...
        mProgressBar = (ImageView) mHeadRootView
...
//							System.out.println("mHeadState == DONE ... _TempY - mStartY = "+(_TempY - mStartY));
    ...
    public void onRefreshComplete() {
        ...
        mHeadState = DONE;
        // 最近更新: Time
        mLastUpdatedTextView.setText(UserCacheDataManager.getInstance().getLastMessageTimeOfCacheDataStr());
        changeHeadViewByState();
