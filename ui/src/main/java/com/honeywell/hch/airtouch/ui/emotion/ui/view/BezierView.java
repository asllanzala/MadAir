...
public class BezierView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        points.add((float) 490.0);
        points.add((float) 118.0);

        points.add((float) 530.0);
        points.add((float) 218.0);

        points.add((float) 557.0);
        points.add((float) 300.0);

        points.add((float) 590.0);
        points.add((float) 100.0);

        points.add((float) 620.0);
        points.add((float) 300.0);
