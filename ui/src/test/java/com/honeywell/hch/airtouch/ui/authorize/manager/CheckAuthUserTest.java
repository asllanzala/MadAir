 ...
 */
public class CheckAuthUserTest extends BaseManagerFunctionTest {
    ...
    public CheckAuthUserTest(AuthorizeManager authorizeManager, MockWebService webService){
    ...
    public void testSuccessCheckAuthUser(){
        ...
        mAuthorizeManager.checkAuthUser(null);
