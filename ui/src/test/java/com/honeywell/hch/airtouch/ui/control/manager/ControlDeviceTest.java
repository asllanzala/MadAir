 ...
 */
public class ControlDeviceTest extends BaseManagerFunctionTest {
    ...
    public ControlDeviceTest(ControlManager controlManager, MockWebService webService,ControlUIManager controlUIManager) {
    ...
    public void testSuccessControlDevice() {
        ...
        if (mControlUIManager != null) {
            mControlUIManager.controlDevice(2323, "1", "aaa");
        } else {
            mControlManager.controlDevice(2323, "1", "aaa");
        }
