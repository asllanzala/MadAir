 ...
 */
public class ProcessAddHomeTest extends BaseManagerFunctionTest {
    ...
    public ProcessAddHomeTest(HomeManagerUiManager homeManagerUiManager, MockWebService webService, HomeManagerManager homeManagerManager) {
        mHomeUiManager = homeManagerUiManager;
        mWebService = webService;
        mHomeManager = homeManagerManager;
    }

    public void testSuccessProcessAddHome() {
        ...
        if (mHomeUiManager != null) {
            mHomeUiManager.processAddHome("Shanghai", "MyHome");
        } else {
            mHomeManager.processAddHome("Shanghai", "MyHome");
        }
    }


    public void testFailProcessAddHome() {
    ...
    public void testLoginFailWhenProcessAddHome() {
