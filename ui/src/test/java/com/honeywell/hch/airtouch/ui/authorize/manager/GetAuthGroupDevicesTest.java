 ...
 */
public class GetAuthGroupDevicesTest extends BaseManagerFunctionTest {
    ...
    public GetAuthGroupDevicesTest(AuthorizeManager authorizeManager, MockWebService webService){
