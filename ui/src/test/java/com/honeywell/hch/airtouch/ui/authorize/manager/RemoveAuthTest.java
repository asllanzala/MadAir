 ...
 */
public class RemoveAuthTest extends BaseManagerFunctionTest {
    ...
    public RemoveAuthTest(AuthorizeManager authorizeManager, MockWebService webService){
    ...
    public void testSuccessRemoveAuth(){
        ...
        mAuthorizeManager.removeAuthDevice(1);
