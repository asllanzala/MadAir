 ...
 */
public class ControlWaterDeviceTest extends BaseManagerFunctionTest {
    ...
    public ControlWaterDeviceTest(ControlManager controlManager, MockWebService webService,ControlUIManager controlUIManager) {
        mControlManager = controlManager;
        mWebService = webService;
        mControlUIManager = controlUIManager;
    }

    public void testSuccessControlDevice() {
        ...
        if (mControlUIManager != null) {
            mControlUIManager.controlWaterDevice(2323, 1, "aaa");
        } else {
            mControlManager.controlWaterDevice(2323, 1, "aaa");
        }
    }


    public void testFailControlDevice() {
    ...
    public void testLoginFailWhenControlDevice() {
