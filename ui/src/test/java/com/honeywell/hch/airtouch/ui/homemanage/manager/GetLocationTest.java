 ...
 */
public class GetLocationTest extends BaseManagerFunctionTest {
    ...
    public GetLocationTest(HomeManagerUiManager homeManagerUiManager, MockWebService webService, HomeManagerManager homeManagerManager) {
    ...
    public void testSuccessGetLocation() {
        ...
        if (mHomeUiManager != null) {
            mHomeUiManager.getLocation();
        } else {
            mHomeManager.getLocation();
        }
    }


    public void testFailGetLocation() {
    ...
    public void testLoginFailWhenGetLocation() {
