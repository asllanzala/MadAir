 ...
 */
public class SwapLocationNameTest extends BaseManagerFunctionTest {
    ...
    public SwapLocationNameTest(HomeManagerUiManager homeManagerUiManager, MockWebService webService, HomeManagerManager homeManagerManager) {
        mHomeUiManager = homeManagerUiManager;
        mWebService = webService;
        mHomeManager = homeManagerManager;
    }

    public void testSuccessSwapLocationName() {
        ...
        if (mHomeUiManager != null) {
            mHomeUiManager.processRenameHome("Vincent", 123);
        } else {
            mHomeManager.processRenameHome("Vincent", 123);
        }
    }


    public void testFailSwapLocationName() {
    ...
    public void testLoginFailWhenSwapLocationName() {
