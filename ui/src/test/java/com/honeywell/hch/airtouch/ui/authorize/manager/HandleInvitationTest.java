 ...
 */
public class HandleInvitationTest extends BaseManagerFunctionTest {
    ...
    public HandleInvitationTest(AuthorizeManager authorizeManager, MockWebService webService){
        mAuthorizeManager = authorizeManager;
        mWebService = webService;
    }

    public void testSuccessHandleInvitation(){

        mResult = true;
        mResponseCode = 200;
        mRequestId = RequestID.HANDLE_AUTH_MESSAGE;
        ...
        mAuthorizeManager.handleInvitation(1, 1);

    }


    public void testFailHandleInvitation(){
    ...
    public void testLoginFailWhenHandleInvitation(){
