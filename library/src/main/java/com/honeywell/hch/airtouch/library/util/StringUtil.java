...
import com.honeywell.hch.airtouch.library.LibConstant;
...
public class StringUtil {
    ...
    public static void maxCharacterFilter(EditText et) {
        try {
            ...
            if (strTransfer.length() > LibConstant.MAX_HOME_CHAR_EDITTEXT) {
                ...
                for (int i = 0; i <= et.getText().toString().length(); i++) {
                    ...
                    if (st.length() == LibConstant.MAX_HOME_CHAR_EDITTEXT) {
