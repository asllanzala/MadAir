...
//    private static final String ANDROID_UPGRADE_JSON_PATH = "https://hch.blob.core.chinacloudapi.cn/hplus-android-version-update/android_Hplus_update_info_googleplay.txt";
    ...
    public void onCreate() {
        ...
        AppManager.getInstance().init(false);
